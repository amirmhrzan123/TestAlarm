        ...
        result.addSource(dbSource) { data ->
            ...
            if (shouldFetch(data)) {
                ...
                result.addSource(dbSource) { newData ->
                    setValue(Resource.success(msg = "success", data = newData))
                }
                fetchFromNetwork(MutableLiveData<ResultType>())
            }
        }
        ...
        result.addSource(apiResponse) { response ->
            ...
            when (response) {
                ...
                is ApiEmptyResponse -> {
                    viewModelScope.launch {
                        result.addSource(loadFromDb()) { newData ->
                            setValue(Resource.success(msg = "", data = newData))
                        }
                    }
...
//                    }
                    result.value = Resource.error("Dwell", response.errorMessage, null)
                }
